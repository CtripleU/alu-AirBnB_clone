...
class TestReview(unittest.TestCase):
    ...
    def test_place_id(self):
        """
        1. test that the place_id attribute of the Review object is an instance of the str class
    ...
    def test_user_id(self):
        """
        1. test that the user_id attribute of the Review object is an instance of the str class
    ...
    def test_text(self):
        """
        1. test that the text attribute of the Review object is an instance of the str class
