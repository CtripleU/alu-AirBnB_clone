...
class TestUser(unittest.TestCase):
    ...
    def test_email(self):
        """
        1. test that the email attribute of the User object is an instance of the str class
    ...
    def test_password(self):
        """
        1. test that the password attribute of the User object is an instance of the str class
    ...
    def test_first_name(self):
        """
        1. test that the first_name attribute of the User object is an instance of the str class
    ...
    def test_last_name(self):
        """
        1. test that the last_name attribute of the User object is an instance of the str class
